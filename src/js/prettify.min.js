                ...
                for (var i = u.PR_SHOULD_USE_CONTINUATION ? f.now() + 250 : 1 / 0; l.length > g && i > f.now(); g++) {
                    ...
                    if (d = s.className, (h !== w || v.test(d)) && !b.test(d)) {
                        ...
                        if (!p) {
                            ...
                            if (L.test(s.tagName))S = 1; else var S = s.currentStyle, _ = o.defaultView, S = (S = S ? S.whiteSpace : _ && _.getComputedStyle ? _.getComputedStyle(s, e).getPropertyValue("white-space") : 0) && "pre" === S.substring(0, 3);
